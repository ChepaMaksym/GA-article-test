...
## Відповідність технічним гіпотезам та immutable artifacts

Початковий експериментальний протокол уже зафіксував технічні поля
`H1`, `H2` і `H3` в JSON, CSV, workflows та immutable artifacts. Їх не
перейменовано заднім числом.

Тому thesis-level H2 є синтезом уже перевірених технічних gates:

| Thesis-level складова | Технічний gate у первинному протоколі |
|---|---|
| H2a - збереження якості | H1 accuracy non-inferiority |
| H2b - компактність subset | H2 selected-feature sparsity |
| H2c - економія logical NFE | H3 exact logical-NFE efficiency |

Це розмежування зберігає відтворюваність: первинні назви полів і
рішення не переписуються, а на рівні магістерської роботи вони
об'єднуються в одну чітко визначену гіпотезу пошукової ефективності.
